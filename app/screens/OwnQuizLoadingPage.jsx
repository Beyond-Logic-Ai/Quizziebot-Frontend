  ...
  useEffect(() => {
    ...
    const loadQuestions = async () => {
      try {
        ...
        console.error('Failed to load questions:', error.response ? error.response.data : error.message);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.contentContainer}>
        <Text style={styles.title}>Own Quiz</Text>
...
export default OwnQuizLoadingPage;
